		...
		<div className="w-full min-h-32  shadow-gray-950 shadow-inner flex flex-col justify-between items-start px-4 py-8 bg-slate-800 text-white">
			...
			<div className="flex items-center justify-start w-full p-4 flex-wrap">
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>Krishna Khandelwal</span>
					<span>Alwar</span>
					<span>
						<Link
							to={"mailto:Krishnakhandelwal8955@gmail.com"}
							target="_blank"
							className="hover:text-blue-600 hover:underline"
						>
							Krishnakhandelwal8955@gmail.com
						</Link>
					</span>
				</div>
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
				...
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://github.com/smartkrishna"
							target="_blank"
							rel="noreferrer"
						>
							Github
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="mailto:Krishnakhandelwal8955@gmail.com"
							target="_blank"
							rel="noreferrer"
						>
							E-Mail
